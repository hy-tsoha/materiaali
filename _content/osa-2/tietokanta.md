...
Jos jälkimmäinen komento ei toimi, voit kokeilla korvata nimen `psycopg2` nimellä `psycopg2-binary`. Tätä ennen kannattaa kuitenkin yrittää ratkaista mahdolliset ongelmat muuten, sillä `psycopg2`:n asennusdokumentaatio varoittaa mahdollisista ongelmista binääriversion kanssa. Esimerkiksi Macin käyttäjille saattaa löytyä tarkistettavia asioita [tästä Stackoverflown kysymyksestä](https://stackoverflow.com/questions/33866695/install-psycopg2-on-mac-osx-10-9-5).
