...
Jos jälkimmäinen komento toimi, voit kokeilla korvata nimen `psycopg2` nimellä `psycopg2-binary`. Tätä ennen kannattaa kuitenkin yrittää ratkaista mahdolliset ongelmat muuten, sillä Psycopg2:n asennusdokumentaatio varoittaa mm potentiaalisista ongelmista binaariversion kanssa. Esimerkiksi Mac-järjestelmän käyttäjille saattaa löytyä tarkistettavia asioita [tästä Stackoverflown kysymyksestä](https://stackoverflow.com/questions/33866695/install-psycopg2-on-mac-osx-10-9-5).
